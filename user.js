...
function init() {
  ...
  // Jamix changes pages/views without a new page load
...
function getPage() {
    ...
    // Jamix URLs should match this pattern: https://usa.jamix.cloud/menu/app?anro=97939&k=[residential college number]
